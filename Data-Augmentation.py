...
if __name__ == '__main__':
    # 图像和标签文件夹
    image_path = r"E:\dataset\PCB_PKU_marked_prepocessing\images\train"
    label_path = r"E:\dataset\PCB_PKU_marked_prepocessing\labels\train"
    save_path = r"E:\dataset\PCB_PKU_marked_prepocessing\results"    # 结果保存位置路径，可以是一个不存在的文件夹
    # 运行
